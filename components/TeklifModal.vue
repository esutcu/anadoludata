...
<template>
 <div v-if="modelValue" class="fixed top-20 inset-x-0 bg-black/50 flex justify-center z-50 min-h-screen">
  <div class="bg-white rounded-lg shadow-xl w-full max-w-lg mt-4">
      <div class="p-6">
